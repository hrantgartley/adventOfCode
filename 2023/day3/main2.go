...
func (c Coordinate) Left() Coordinate   { return Coordinate{c.i, c.j - 1} }
func (c Coordinate) Right() Coordinate  { return Coordinate{c.i, c.j + 1} }
func (c Coordinate) Top() Coordinate    { return Coordinate{c.i - 1, c.j} }
func (c Coordinate) Bottom() Coordinate { return Coordinate{c.i + 1, c.j} }

func gearRatio(m map[Coordinate]byte, c Coordinate) int {
	numbers := []int{}
...
func expandNumber(m map[Coordinate]byte, c Coordinate) int {
	for isDigit(m[c.Left()]) {
		c.j--
	}
	num := 0
	for ; isDigit(m[Coordinate{c.i, c.j}]); c.j++ {
